...
<?php $postid = get_the_ID(); ?>
    ...
    <section id="hero-general">
        <div id="background" style="background-image: url('<?php the_post_thumbnail_url(); ?>')">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h1 style="font-size: 70px;"><?php _e('Story', 'musheghavetisyan'); ?></h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="callout cta-bar-bottom">
        <div class="container-fluid">
            <p><?php _e('Want to see Mushegh\'s live stories?', 'musheghavetisyan'); ?></p>

            <a href="#" class="btn btn-blue newsletter"><?php _e('ACT NOW', 'musheghavetisyan'); ?></a>
        </div>
    </div>
    ...
    <div id="form-newsletter" class="overlay hidden"> <a class="overlay-close" href="#">
        ...
        <div>
            <div class="col-xs-10 text-center center">
                <h2><?php _e('DISCOVER HOW TO TAKE YOUR LIFE TO THE NEXT LEVEL TODAY.', 'musheghavetisyan'); ?></h2>
