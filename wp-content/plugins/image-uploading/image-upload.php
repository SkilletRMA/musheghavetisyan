<?php
     ...
     * Description: Install this plugin, if you want upload image to a page.
     * Author: Tigran Soghoyan
     * Author URI: http://tiko98toto.000webhostapp.com
     * Version: 1.0
     * License: GPLv2
     */
    namespace image_uploading;

    function register_metaboxes() {
        add_meta_box('image_metabox', 'Image Uploader', __NAMESPACE__ . '\image_uploader_callback', array('page', 'podcast', 'event'));
    }
