...
class WPCustomCategoryImage
{
    ...
    {
        return array_merge($columns, array('image' => __('Icon', 'wpcustom-category-image')));
    }
    ...
    public function admin_enqueue_assets($hook)
    {
        ...
        wp_localize_script('category-image-js', 'CategoryImage', array(
            'wp_version' => WPCCI_WP_VERSION,
                'label'      => array(
                    'title'  => __('Choose Category Icon', 'wpcustom-category-image'),
                    'button' => __('Choose Icon', 'wpcustom-category-image')
                )
            )
        );
    ...
    public function taxonomy_field($template, $taxonomy)
    {
        $params = array(
            'label'  => array(
                'image'        => __('Icon', 'wpcustom-category-image'),
                'upload_image' => __('Upload/Edit Icon', 'wpcustom-category-image'),
                'remove_image' => __('Remove Icon', 'wpcustom-category-image')
            ),
